...
# 循环初始化主数据库
MAIN_DB_LIST=("d_taiwan" "d_channel" "d_guild" "d_taiwan_secu" "d_technical_report")
...
update db_connect set db_ip="127.0.0.1", db_port="3306", db_name="d_taiwan_secu", db_passwd="$DEC_GAME_PWD" where db_server_group=$SERVER_GROUP and db_type = 10;
update db_connect set db_ip="127.0.0.1", db_port="3306", db_name="d_technical_report", db_passwd="$DEC_GAME_PWD" where db_server_group=$SERVER_GROUP and db_type = 15;
update db_connect set db_ip="127.0.0.1", db_port="3307", db_name="taiwan_$SERVER_GROUP_NAME", db_passwd="$DEC_GAME_PWD" where db_server_group=$SERVER_GROUP and db_type=2;
update db_connect set db_ip="127.0.0.1", db_port="3307", db_name="taiwan_${SERVER_GROUP_NAME}_2nd", db_passwd="$DEC_GAME_PWD" where db_server_group=$SERVER_GROUP and db_type=3;
update db_connect set db_ip="127.0.0.1", db_port="3307", db_name="taiwan_${SERVER_GROUP_NAME}_log", db_passwd="$DEC_GAME_PWD" where db_server_group=$SERVER_GROUP and db_type=4;
update db_connect set db_ip="127.0.0.1", db_port="3307", db_name="taiwan_${SERVER_GROUP_NAME}_web", db_passwd="$DEC_GAME_PWD" where db_server_group=$SERVER_GROUP and db_type=5;
update db_connect set db_ip="127.0.0.1", db_port="3307", db_name="taiwan_login", db_passwd="$DEC_GAME_PWD" where db_server_group=$SERVER_GROUP and db_type=6;
update db_connect set db_ip="127.0.0.1", db_port="3307", db_name="taiwan_prod", db_passwd="$DEC_GAME_PWD" where db_server_group=$SERVER_GROUP and db_type=7;
update db_connect set db_ip="127.0.0.1", db_port="3307", db_name="taiwan_game_event", db_passwd="$DEC_GAME_PWD" where db_server_group=$SERVER_GROUP and db_type=9;
update db_connect set db_ip="127.0.0.1", db_port="3307", db_name="taiwan_login_play", db_passwd="$DEC_GAME_PWD" where db_server_group=$SERVER_GROUP and db_type=11;
update db_connect set db_ip="127.0.0.1", db_port="3307", db_name="taiwan_${SERVER_GROUP_NAME}_auction_gold", db_passwd="$DEC_GAME_PWD" where db_server_group=$SERVER_GROUP and db_type=12;
update db_connect set db_ip="127.0.0.1", db_port="3307", db_name="taiwan_se_event", db_passwd="$DEC_GAME_PWD" where db_server_group=$SERVER_GROUP and db_type=13;
update db_connect set db_ip="127.0.0.1", db_port="3307", db_name="taiwan_billing", db_passwd="$DEC_GAME_PWD" where db_server_group=$SERVER_GROUP and db_type=14;
EOF
# 测试并查询数据库连接设置
...
EOF
echo "main_db: init server group-$SERVER_GROUP($SERVER_GROUP_NAME) done."
